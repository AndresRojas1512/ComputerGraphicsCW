...
public:
    ...
    ATXMotherboardConfig(const Dot3D &startOfPlate_, const Dot3D &endOfPlate_)
        ...
        CPUFAN({ParallelepipedConfig(startOfPlate_.getXCoordinate() + ATX_CPUFAN_OFFSET_X, startOfPlate_.getYCoordinate() + ATX_CPUFAN_OFFSET_Y, BASE_Z + ATX_CPUFAN_DEPTH, ATX_CPUFAN_WIDTH, ATX_CPUFAN_HEIGHT, ATX_CPUFAN_DEPTH)}, {FrameConfig(startOfPlate_.getXCoordinate() + ATX_CPUFAN_OFFSET_X, startOfPlate_.getYCoordinate() + ATX_CPUFAN_OFFSET_Y, BASE_Z + ATX_CPUFAN_FRAME_DEPTH, ATX_CPUFAN_WIDTH, ATX_CPUFAN_HEIGHT, ATX_CPUFAN_FRAME_DEPTH, ATX_CPUFAN_FRAME_WIDTH, ATX_CPUFAN_FRAME_WIDTH, ATX_CPUFAN_FRAME_WIDTH, ATX_CPUFAN_FRAME_WIDTH)}, {}),
        // RAM slots offset
