...
{
    std::cout << "AddBrick::AddBrick" << std::endl;
    ui->setupUi(this);
...
{
    std::cout << "AddPlate::AddPlate" << std::endl;
    ui->setupUi(this);
...
{
    std::cout << "AddPlate::on_buttonBox_accepted" << std::endl;
    status = CANCEL;
...
{
    std::cout << "AddTile::AddTile" << std::endl;
    ui->setupUi(this);
...
{
    std::cout << "AddTile::on_buttonBox_accepted" << std::endl;
    status = CANCEL;
...
{
    std::cout << "AddArc::AddArc" << std::endl;
    ui->setupUi(this);
...
{
    std::cout << "AddCylinder::AddCylinder" << std::endl;
    ui->setupUi(this);
